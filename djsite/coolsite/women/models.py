...
class Women(models.Model):
    ...
    cat = models.ForeignKey('Category', on_delete=models.PROTECT, verbose_name="Категория")                # 'Category' имя класса в кавычках поскольку class Category идет после class Women
